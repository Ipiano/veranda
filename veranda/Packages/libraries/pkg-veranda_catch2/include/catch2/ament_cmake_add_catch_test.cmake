function(ament_add_catch_test target)
    ...
    # Use modern target_link_libraries instead of deprecated qt5_use_modules
    set(QT_TARGETS Qt5::Core)
    foreach(qt_lib ${ARG_QT_LIBS})
        list(APPEND QT_TARGETS Qt5::${qt_lib})
    endforeach()
